    ...
    <header className="sticky top-0 z-50 bg-brand-bg/95 backdrop-blur-md border-b border-brand-border">
      <div className="layout-container h-20 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <Link 
            href="/#features" 
            className="bg-brand-accent hover:bg-brand-accent-hover text-brand-main px-6 py-2.5 rounded-full font-bold shadow-soft transition-all duration-200 hover:-translate-y-0.5 border border-brand-main/10 text-sm"
          >
            {dict.cta}
          </Link>
        </div>
